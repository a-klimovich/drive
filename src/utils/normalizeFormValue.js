...
const normalizeValue = (data) => {
  ...
  return {
    ...
    date_insurance_from: date_insurance_from ? moment(date_insurance_from) : '',
    date_insurance_stop: date_insurance_stop ? moment(date_insurance_stop) : '',
    date_membership_exclusion: date_membership_exclusion ? moment(date_membership_exclusion) : '',
    date_membership_start: date_membership_start ? moment(date_membership_start) : '',
